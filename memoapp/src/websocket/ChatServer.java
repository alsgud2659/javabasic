...
public class ChatServer {
	...
	//Collections클래스의 synchronizedSet() 매서드는 안전하게 Set컬랙션을 생성해준다. 
	...
	//클라이언트로부터 메세지를 받았을때 실행되는 매서드를 정의한다. 클라이언트가 보낸 메시지와
	...
	// 클라이언트가 접속을 종료했을때 실행되는 매서드를 정의한다. clients에서 해당 세션을 삭제한다. 
