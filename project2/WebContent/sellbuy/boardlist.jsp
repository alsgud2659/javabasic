...
<%  ArrayList<sellbuyDTO> sellbuyss =(new sellbuyDAO()).getList();
...
%>
    ...
    <%@ include file="/sellbuy/headerin.jsp"%>	
     <%@ include file="/sellbuy/allcate.jsp"%>	
</div>
...
<div class="container my-3">
    <table class="table table-striped table-hover">
		...
		<%
		 ArrayList<sellbuyDTO> pagess =(new sellbuyDAO()).getpageList(startRow,pageSize);
        for(sellbuyDTO pages : pagess){
				String img = pages.getSbimage(), imgstr=null;
				if(img != null){
