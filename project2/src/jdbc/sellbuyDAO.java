...
public class sellbuyDAO {
	...
	public boolean insert(String sbid, String sbclass, String sbtitle, String sbcontent, String sbuser, String sbimage, String sbcate)
	throws NamingException, SQLException {
		...
		try {
			...
			pstmt = conn.prepareStatement(sql);			
				...
				pstmt.setString(2, sbclass);
				pstmt.setString(3, sbtitle);
				pstmt.setString(4, sbcontent);
				pstmt.setString(5, sbuser);
				pstmt.setString(6, sbimage);
				pstmt.setString(7, sbcate);
