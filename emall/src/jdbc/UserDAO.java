...
public class UserDAO {
	public int insert(String uid, String upw, String uname, String ugender, String ubirth, String uemail, String uphone, String uaddr)
	...
	public int login(String uid, String upw) throws NamingException, SQLException {
		...
		try {
			...
			if(!upw.equals(rs.getString("upw"))) return 2; // 암호가 틀린 경우
