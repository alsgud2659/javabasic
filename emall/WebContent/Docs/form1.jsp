...
type
	text - 기본값으로 한줄 텍스트를 입력받을 때 사용
	radio - 여러개 제시된 값들 중 단 하나만 선택
	checkbox - 여러개 제시된 값들 중 여러개 선택
	password - 암호입력
	hidden - 보이지 않게 값을 숨겨서 전송할 때 사용
	file - 파일, 사진을 업로드 하기 위한 파일 선택용으로 사용
	button - 버튼 모양으로 출력
	...
	<div style="text">
		<form action="form1db.jsp">
			...
			운동 <input type="checkbox" name="hobby" value="운동"> 영화 <input
				type="checkbox" name="hobby" value="영화"> <br>
			
				<textarea rows="3" cols="30" align="center"></textarea>
