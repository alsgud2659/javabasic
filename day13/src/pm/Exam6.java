...
/*
 제네릭을 사용하면 모든 타입의 상품을 저장할수도 있으면서도 잘못된 캐스팅을 할때
 ...
 제네릭 클래스인 MyClass<T> 는 제네렉 타입 변수 1개를 갖고 있다. 
 이 제네릭 타입은 필드 타입 getter매서드의 리턴 타입 setter매서드의 입력 타입에
 사용됐다. 
 
 제네릭 인터페이스인 MyInterface<K,V> 는 2개의 제네릭 타입변수를 갖고 있고 
 각각 setter와 getter 매서드의 입려과 리턴타입으로 사용되고 있다. 
