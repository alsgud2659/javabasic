...
<!-- container : 화면 전체를 차지하지 않는 고정된 크기를 지정하는 컨테이너로 브라우저의 크기 변동에 반응
bg-warning : 배경색을 지정한다. shadow 그림자 효과를 추가하여
mx-auto : 자동으로 크기를 적절하게 배치
mt-5 : 박스가 브라우저 상단에 붙지 않도록 최대 margin을 설정 0 ~ 5
p-5 : 박스 안쪽 여백을 설정
w-75 박스의 크기를 브라우저의 크기의 75퍼센트로 유지 -->
