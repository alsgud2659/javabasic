...
<%@ include file="/menu.jsp"%>
  ...
  <%
  	...
  	String nsj = each.getNsj(); 
  	String nct = each.getNct(); 
  ...
  %>                             
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <a href="<%=each.getNlk() %>" target="_blank"><button class="btn btn-primary btn-lg" type="button">원문보기</button></a>
      </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><a href="searchcheck.jsp?col=nca&word=컴터">컴터</a></li>
                                        <li><a href="searchcheck.jsp?col=nca&word=기타">기타</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <li><a href="searchcheck.jsp?col=nct&word=JavaScript">JavaScript</a></li>
                                        <li><a href="searchcheck.jsp?col=nct&word=JavaScript">CSS</a></li>
                                        <li><a href="searchcheck.jsp?col=nct&word=Tutorials">Tutorials</a></li>
                                        <li><a href="searchcheck.jsp?col=nct&word=코인">코인</a></li>
                                        <li><a href="searchcheck.jsp?col=nct&word=개발자">개발자</a></li>
                                        <li><a href="searchcheck.jsp?col=nct&word=구인">구인</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
